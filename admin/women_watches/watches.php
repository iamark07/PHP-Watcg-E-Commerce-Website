...
<body>
    ...
    <main class="bg-zinc-300 w-full min-h-[100dvh] flex flex-col items-center gap-10 py-20 px-5 md:px-5">
        ...
        <div class="relative w-full">
            ...
            $offset = ($page - 1) * $limit;
            $sql = "SELECT women_watches.watch_id, women_watches.watch_title, women_watches.watch_description, women_watches.category, women_watches.watch_date, all_watches.save_watch_id, all_watches.target_audience, watch_target_audience.target_audience_id, category.category_id, category.category_product_name, watch_brand.brand_id, watch_brand.watch_brand_name, user.username,women_watches.watch_amount FROM women_watches
            ...
            WHERE all_watches.target_audience = 2
            ORDER BY women_watches.watch_id DESC LIMIT {$offset},{$limit}";
            ...
            $sql1 = "SELECT * FROM women_watches";
