...
<body>
    ...
    <main class="bg-zinc-300 w-full min-h-[100dvh] flex flex-col items-center gap-10 py-20 px-5 md:px-5">
        ...
        <div class="relative w-full">
            ...
            $offset = ($page - 1) * $limit;
            $sql = "SELECT wall_watches.watch_id, wall_watches.watch_title, wall_watches.watch_description, wall_watches.category, wall_watches.watch_date, all_watches.save_watch_id, all_watches.target_audience, watch_target_audience.target_audience_id, category.category_id, category.category_product_name, clock_brand.brand_id, clock_brand.watch_brand_name, user.username, wall_watches.watch_amount 
        FROM wall_watches
        ...
        LEFT JOIN clock_brand ON wall_watches.watch_brand_name = clock_brand.brand_id
        LEFT JOIN user ON wall_watches.Author = user.user_id
        WHERE all_watches.target_audience = 4
        ORDER BY wall_watches.watch_id DESC 
        LIMIT {$offset},{$limit}";
