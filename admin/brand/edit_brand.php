...
<body>
            ...
            <nav class="hidden lg:block">
                <ul class="animate_text_color flex gap-5">
                    ...
                    if ($_SESSION["user_role"] == 1) {
                        ?>
                        <li class="text-black"><a href="../wall_watches/watches.php">Wall Watch</a></li>
                        ...
                        <li class="text-blue-500"><a href="brand.php">Watch Brand</a></li>
    ...
    if (isset($_POST['edit'])) {
        ...
        $sql = "UPDATE watch_brand SET watch_brand_name = '{$brand_input}' WHERE brand_id = {$brand_id}";
    ...
    <main class="flex justify-center items-center flex-col bg-zinc-100 p-5 md:px-20">
        ...
        $sql1 = "SELECT * FROM watch_brand WHERE brand_id = {$brand_id}";
