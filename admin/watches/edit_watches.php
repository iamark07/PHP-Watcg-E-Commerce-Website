...
<body>
    ...
    <main class="flex justify-center items-center flex-col bg-zinc-100 p-5 md:px-20">
        ...
        $sql = "SELECT watches.watch_id, watches.watch_title, watches.watch_description, watches.category AS watches_category, 
        watches.watch_img, watches.watch_brand_name, watches.watch_amount, watches.img_folder_name, 
        ...
        WHERE watches.watch_id = {$watches_id} AND target_audience = {$watch_cat}";
