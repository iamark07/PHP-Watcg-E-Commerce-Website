...
<body>
    ...
    if (isset($_POST['add'])) {
        ...
        $count_category_items = 0;

        // Insert the category and the updated count into the database
        $sql = "INSERT INTO category (category_product_name, count_category_items)
                    VALUES('{$add_category}', '{$count_category_items}')";
    ...
    <main class="flex justify-center items-center flex-col bg-zinc-100 p-5 md:px-20">
        <h2 class="mt-5 text-blue-400 text-2xl text-start">Add Category</h2>
        ...
        <input type="text" class="col-span-1 px-5 py-3 border border-zinc-500 text-zinc-500 rounded outline-none" name="add_category" placeholder="Add Category" required>
