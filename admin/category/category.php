...
<body>
    ...
    <main class="bg-zinc-300 w-full h-[100dvh] overflow-auto flex flex-col items-center gap-10 py-20 px-5 md:p-20">
        ...
        <div class="relative w-full md:w-3/4">
            ...
            ?>
                ...
                <div class="table_overflow overflow-x-auto w-full">
                    <table class="w-full bg-zinc-800 mt-10">
                        <thead>
                            <tr>
                                <td class="text-white font-semibold text-lg border border-zinc-600 text-center p-5">Category id</td>
                                <td class="text-white font-semibold text-lg border border-zinc-600 text-center p-5">Category Name</td>
                                <td class="text-white font-semibold text-lg border border-zinc-600 text-center p-5">no of Category Product</td>
                        ...
                        <tbody class="bg-zinc-200">
                            ...
                            ?>
                                <tr>
                                    <td class="text-black text-md border border-zinc-500 text-center p-5"><?php echo $row['category_id']; ?></td>
                                    <td class="text-black text-md border border-zinc-500 text-center p-5"><?php echo $row['category_product_name']; ?></td>
                                    <td class="text-black text-md border border-zinc-500 text-center p-5"><?php echo $row['count_category_items']; ?></td>
                                    <td class="text-black font-semibold text-lg border border-zinc-500 text-center p-5">
                                        <a href="edit_category.php?id=<?php echo $row['category_id']; ?>"><i class="ri-pencil-line"></i></a>
                                    </td>
                                    <td class="text-black font-semibold text-lg border border-zinc-500 text-center p-5">
                                        <a href="delete_category.php?id=<?php echo $row['category_id']; ?>"><i class="ri-delete-bin-2-line"></i></a>
                                    </td>
                                </tr>
                            <?php
                            }
            ...
            ?>
            <button class="bg-blue-400 text-white text-lg px-5 py-3 absolute right-0 -top-10"><a href="add_category.php">Add Category</a></button>
        ...
        <ul class="flex justify-center gap-3">';
                ...
                if ($page > 1) {
                    echo '<li><a href="category.php?page=' . ($page - 1) . '" class="text-white bg-blue-400 px-4 py-3 rounded">Prev</a></li>';
                }

                // Generate page number links
                for ($i = $start_page; $i <= $end_page; $i++) {
                    $active = $i == $page ? '!bg-blue-500' : '';
                    echo '<li><a href="category.php?page=' . $i . '" class="text-white ' . $active . ' bg-blue-400 px-4 py-3 rounded">' . $i . '</a></li>';
                }

                if ($page < $total_pages) {
                    echo '<li><a href="category.php?page=' . ($page + 1) . '" class="text-white bg-blue-400 px-4 py-3 rounded">Next</a></li>';
                }
