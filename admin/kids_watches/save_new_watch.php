...
$sql = "INSERT INTO kids_watches (watch_title, watch_description, watch_brand_name, category, watch_date, Author, watch_img, watch_amount, img_folder_name)
...
if (mysqli_query($conn, $sql)) {
    ...
    $source_table = 'kids_watches'; // Example for wall watches. Adjust based on the actual source.
    $all_brand_id = 1;
    $sql_all_watches = "
